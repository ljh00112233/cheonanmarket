...
class API extends React.Component{
  ...
  getMarket(){
    const url = `https://apis.data.go.kr/4490000/bcmarket/bcmarketList?serviceKey=Xz56j4w4KJdgmRWwojz11Ut9YdMHO0teXRXmlNWh7EaC35ouuXGGL5Cj2L1ktToNjtGqvLKh5nJXZNMxkixofg%3D%3D&type=json`;
    console.log(url);
